...
| `S1-05` | READY | Research agent | Determine whether the compliance change appears on matched benign instructions. | Twins and grader built and smoke-tested. Paused at a clean boundary for `S1-3F-ADJ`; resume at the sbatch. | `docs/experiments/09-07_benign-twins_control.md` |
...
| `S1-3F-ADJ` | IN_PROGRESS | Research agent | Measure dispersion of concession thresholds across model families, and name the operational line the rubric left undefined. | Gemini sheet returned and validated 150/150. Run the frozen sensitivity, then characterize the 11 crossings. | `docs/experiments/09-04_3f-adj_third-rater-sensitivity.md` |
