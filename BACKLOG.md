...
| `S1-SYNTH` | BLOCKED | Research agent | Produce the Stage 1 verdict and frozen Stage 2 endpoints. | Task-dependency blocked on `S1-05` and `S1-06`. No person needs to act, so no INBOX ID. | `STATUS.md` Stage 1 exit criteria |
