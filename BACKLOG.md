...
| `S1-3F-ADJ` | PARKED | Research agent | Settle whether the unqualified/concessionary threshold difference favours either rater. | Adjudicate the 11 `unqualified`→`concessionary` crossing items with a third rater. Cheap; would resolve a rater-dependent verdict. | `docs/experiments/09-04_phoenix-starling_concessionary-endorsement.md` |
