...
| `S1-CKPT` | IN_PROGRESS | Research agent | Localize the Phoenix→Starling behavior change using three public cooldown revisions. | Current: freeze the primary behavior measure and timing rules before viewing outcomes. Match the endpoint protocol; pin full SHAs and verify downloaded weights for 1,340,000 / 1,360,000 / 1,380,000. Apply the interpretation limits below. No David gate. | `docs/experiments/09-08_cooldown_localization.md`; `outputs/2026-09-07_cooldown-config-audit/checkpoint-evidence.json` |
