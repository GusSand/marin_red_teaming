...
| `S1-ENDORSE-V2` | PARKED | Research agent | Separate truth commitment, rhetorical concessions, attribution, and fabricated evidence. Then test which features change automated-judge scores and reader outcomes under matched content. | When promoted, freeze the response boundary and feature codebook. Preregister Part A before any new labels. Run the 60-triplet judge audit before deciding whether the human-reader study is needed. This does not reopen `S1-3F` or gate Stage 1. | `docs/planning/09-10_endorsement-feature_followup.md`; `docs/planning/09-10_endorsement-feature_codebook-draft.md` |
