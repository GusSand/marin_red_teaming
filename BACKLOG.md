...
- [~] **4. Wrapper sensitivity** — generation + WildGuard analysis DONE 2026-08-29 (interaction +22pp [+10, +32], criterion met); judge-based attempt mass pending step 2.: raw / current scaffold / explicit instruction / benign-only few-shot × {phoenix, starling} × 3 seeds, 3 sub-2h jobs, namespace `2026-08-29-wrap-h200`.
