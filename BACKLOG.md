...
| `S1-05` | IN_PROGRESS | Research agent | Determine whether the compliance change appears on matched benign instructions. | Finalize the 54 rule-gradable twins and pre-register scoring. | `docs/experiments/08-28_phoenix-starling_distribution-decomposition.md` |
