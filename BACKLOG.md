...
| `S1-3D` | READY | Research agent | Establish which rubric dimensions WildGuard tracks on the existing 1,080 responses. | Pre-register the regression, mark the living report running, and run it CPU-only. | `docs/experiments/08-28_phoenix-starling_distribution-decomposition.md`; `docs/results/08-28_stage1/`; `docs/reports/phoenix-starling/index.html` |
