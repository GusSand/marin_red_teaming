...
| `S1-ENDORSE-V2` | IN_PROGRESS | Research agent | Separate truth commitment, rhetorical concessions, attribution, and added purported evidence. Then test which features change automated-judge scores under matched content. | Part A is frozen. Build the 1,080-row blinded package, run two independent full-set raters, seal both outputs, and execute the 100-row disagreement audit before interpreting checkpoint differences. | `docs/experiments/09-10_endorsement-feature_decomposition.md`; `config/endorsement_feature_codebook_v1.md` |
