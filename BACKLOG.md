...
| `S1-3F` | READY | Research agent | Split endorsement into unqualified, concessionary, and misclassified correction/hedge. | Preregistration frozen 2026-09-04; deferred behind `S1-STANCE-GAP`, which measures the same artefact more directly. | `docs/experiments/09-04_phoenix-starling_concessionary-endorsement.md` |
...
| `S1-STANCE-GAP` | IN_PROGRESS | Research agent | Quantify whether restatement-without-assertion items bias the −12.2 / −12.2 / +28.5pp headline. | Preregistration frozen 2026-09-04; rate a 240-item blinded stratified sample, then verify independently. | `docs/experiments/09-04_stance-gap_restatement-prevalence.md` |
