# Trajectory analysis: 2026-08-28-traj4-h200
...
Judge labels missing (None): kestrel 28 (non-empty 6), ocelot 20 (non-empty 2), jellyfish 21 (non-empty 8), phoenix 1 (non-empty 1), starling 1 (non-empty 1), deeper-starling 0 (non-empty 0)
